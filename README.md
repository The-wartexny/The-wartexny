...
**The-wartexny/The-wartexny** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.

Here are some ideas to get you started:![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=The-wartexny🚀&fontSize=50&fontAlign=50&fontAlignY=35&animation=fadeIn)
...
| ------------- | ------------- |
| ![Трофеи](https://github-profile-trophy.vercel.app/?username=The-wartexny&theme=radical) | ![Граф активности](https://github-readme-activity-graph.vercel.app/graph?username=The-wartexny&theme=react-dark) |
